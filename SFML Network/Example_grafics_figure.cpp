...
int main()
{
	...
	while (window.isOpen())
	{
		...
		triangle.setPosition(125, 15); // устанавливаем начальную позицию справа от круга
		...
		square.setPosition(250, 15); // устанавливаем начальную позицию справа от треугольника
		...
		octagon.setPosition(380, 15); // устанавливаем начальную позицию справа от квадрата
